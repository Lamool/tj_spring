...
function api1() {
    $.ajax({
        async : false,
        method : "get",
        url : "https://api.odcloud.kr/api/15102672/v1/uddi:5e2a4b30-28fb-4e8f-bc44-9a6db8a6a8db?page=1&perPage=39&serviceKey=cR0U2MVNi888EyWgGsczYVEPXBYaGxq2n9pt9YgfjnuVGLcvyCjYE9xwKplo3qQry9zwIP6eHFCiE%2B21wKUaiA%3D%3D",
...
function api2() {
    $.ajax({
        async : false,
        method : "get",
        url : 'https://api.odcloud.kr/api/15051492/v1/uddi:852bbc11-63ed-493e-ab09-caaaf54fd144?page=1&perPage=35&serviceKey=cR0U2MVNi888EyWgGsczYVEPXBYaGxq2n9pt9YgfjnuVGLcvyCjYE9xwKplo3qQry9zwIP6eHFCiE%2B21wKUaiA%3D%3D',
        success : r => {    console.log(r);
            // 1. 어디에
...
function api3(data) {   // 매개변수 : api2에서 전달받은 약국정보리스트
    ...
    // let container = document.querySelector('#map'); 를 써도 됨
