/*
    ...
    3. DCL : 제어어
        ...
        rollback : 작업 반영 취소
        savepoint : 작업 위치 지정 (이후 해당 위치 이동 가능)
	...
	4. 연산자
        ...
        4. 기타연산자 :
			1. between시작값 and 끝값 : 시작값부터 끝값까지의 포함된 값
    ...
    7. 제약조건
        ...
        [6] foreign key : 참조키(다른 테이블의 식별키 필드를 참조하는 필드)
        [7] 제약조건 옵션
