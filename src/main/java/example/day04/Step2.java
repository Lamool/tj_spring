...
public class Step2 {
    public static void main(String[] args) {
        ...
        // [6] 문자열.indexOf("찾을문자열") : 문자열내 찾을 문자가 존재하면 찾은 문자열의 인덱스 반환, 없으면 -1 반환
        ...
        // 문자와 바이트 관계
            ...
            // 2. 한글 : 문자1개당 2바이트 + 규칙 1바이트 => 총 3바이트
        byte _byte1= 'a';
        System.out.println("_byte1 = ");
        ...
        System.out.println("_char1 = " + (int)_char1);
        ...
        System.out.println((char)(new Random().nextInt(26) + 97));  // a ~ z의 영소문자 난수 생성
