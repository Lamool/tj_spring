    ...
    public static void main(String[] args) {
        ...
        // 래퍼클래스 : 기본타입 --> 참조타입, 기본타입을 참조타입으로 만들기
            // 기본타입을 참조타입으로 사용해야 되는 경우가 있다.
                ...
                // 기본타입의 데이터가 메소드/기능 를 사용해야 되는 경우가 있을 수 있다. (주로, 타입변환)
        ...
        // ======= 문자열 타입을 기본 타입으로 변환 : 주로 자바 외 데이터를 가져올 때 ======= //
        ...
        Integer vlaue12 = value11; // 참조타입 = 기본타입 (오토박싱)
        ...
        // [2]
        try {
            Class c3 = Class.forName("java.lang.String");   // class java.lang String
        ...
        // ---
        try {
            Class c4 = Class.forName("java.lang.String");   // class java.lang String
