...
public class Step1 {
    public static void main(String[] args) {
        ...
        // 1. 리스트 컬렉션
        // ((List와 ArrayList 아무거나 선언해도 되지만 ArrayList는 타입 변환이 어렵다))
        List<String> list = new ArrayList<>();      // 인터페이스
        list = new Vector<>();      // 다른 구현체로 바꿔치기 가능
        list = new LinkedList<>();
       ...
       // ArrayList<String> list2 = new ArrayList<>();    // 클래스
        ...
        // 3. 리스트내 특정 위치 요소 추가
        list.set(0, "박명수");
        // list.set(4, "김희철");      // ((에러. 현재 인덱스 3까지라서))
        System.out.println("list = " + list);
        ...
        // 9-4. .stream().map.collect(), 요소의 개수를 하나씩 반환해서 반복후 결과(return) 해서 반환, return 있다.
            // 반복하면서 return 값들을 하나의 배열/컬렉션으로 반환 받을 수 있다.
            // 주로 카피/복사 할 때 사용된다, 반복하면서 실행결과를 반환 받을 수 있다.
        ...
        System.out.println("1만개 저장하는 ArrayList 걸린 시간 : " + result);
        ...
        endTime = System.nanoTime();
        result = endTime - startTime;
        System.out.println("1만개 저장하는 LinkedList 걸린 시간 : " + result);
